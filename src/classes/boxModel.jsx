    ...
    <>
      ...
      <h2>SELECTORS AND PSEUDO SELECTORS </h2>
        ...
        <table >
            ...
            <tr>
                <td><a href="#element~element">element1~element2</a></td>
                <td>p ~ ul</td>
            ...
            <tr>
                <td><a href="#[atribute]">[attibute]</a></td>
                <td>[target]</td>
            ...
            <tr>
                <td><a href="#beforeafter">::after</a></td>
                <td>p:after</td>
                <td>{'Insert something after the content of each <p> element'}</td>
            </tr>
            <tr>
                <td><a href="#beforeafter">::before</a></td>
                <td>p:before</td>
            ...
            <tr>
                <td>< a href="#firstlastnth">:first-child</a></td>
                <td>p:first-child</td>
            ...
            <tr>
            <td><a href="#firstlastnth">:last-child</a></td>
                <td>p:last-child</td>
            ...
            <tr>
                <td>< a href="#firstlastnth">:nth-child(n)</a></td>
                <td>p:nth-child(2)</td>
        ...
        <div class="examples">
            ...
            <Text.Blue nr_idents={1}>{'<h2>'} </Text.Blue> Era uma vez<Text.Blue>{'</h2>'} </Text.Blue><br></br>
            <Text.Blue nr_idents={1}>{'<p>'} </Text.Blue> umas<Text.Blue>{'</p>'} </Text.Blue><br></br>
            <Text.Blue>{'</div>'} </Text.Blue><br></br>
            <p></p>
            <Text.Blue>{'<div>'} </Text.Blue><br></br>
        ...
        <div class="examples">
            ...
            <Text.Blue>{'</div>'} </Text.Blue><br></br>
            <p></p>
            <Text.Blue >{'<p>'} </Text.Blue> Batatas<Text.Blue>{'</p>'} </Text.Blue><br></br>
            <Text.Blue >{'<p>'} </Text.Blue> Fritas<Text.Blue>{'</p>'} </Text.Blue><br></br>
        ...
        <div className={'document_examples atribute'}>
            ...
            <a href="http://www.disney.com" >disney.com</a><br></br>
        ...
        <div class="examples">
            <Text.Orange> {'p::'} </Text.Orange><Text.Green>{'after'}</Text.Green> {'{'}
            <Text.Purple>content:</Text.Purple><Text.Green>" - after "</Text.Green>
            <Text.Orange> {'}'} </Text.Orange>
            <br>
            </br>
            <Text.Orange> {'p::'} </Text.Orange><Text.Green>{'before'}</Text.Green> {'{'}
            <Text.Purple>content:</Text.Purple><Text.Green>" - before "</Text.Green>
            <Text.Orange> {'}'} </Text.Orange>
            <p>
            </p>
            <Text.Blue >{'<p>'} </Text.Blue> Batatas<Text.Blue>{'</p>'} </Text.Blue><br></br>
        ...
        <div class="examples">
            ...
            <Text.Purple>background-color:</Text.Purple><Text.Green>yellow</Text.Green>
            <Text.Orange> {'}'} </Text.Orange>
            <br>
            </br>
            <Text.Orange> {'div p::last-child'} </Text.Orange> {'{'}
            <Text.Purple>background-color:</Text.Purple><Text.Green>red</Text.Green>
            <Text.Orange> {'}'} </Text.Orange>
            <br>
            </br>
            <Text.Orange> {'div p::nth-child(4n)'} </Text.Orange> {'{'}
            <Text.Purple>background-color:</Text.Purple><Text.Green>orange</Text.Green>
            <Text.Orange> {'}'} </Text.Orange>
            <p></p>
            <Text.Blue>{'<div>'}</Text.Blue> <br></br>
            <Text.Blue nr_idents={1}>{'<p>'} </Text.Blue> Batata<Text.Blue>{'</p>'} </Text.Blue><br></br>
            <Text.Blue nr_idents={1}>{'<p>'} </Text.Blue> Frita<Text.Blue>{'</p>'} </Text.Blue><br></br>
            <Text.Blue nr_idents={1}>{'<p>'} </Text.Blue> Pala<Text.Blue>{'</p>'} </Text.Blue><br></br>
            <Text.Blue nr_idents={1}>{'<p>'} </Text.Blue> -<Text.Blue>{'</p>'} </Text.Blue><br></br>
            <Text.Blue nr_idents={1}>{'<p>'} </Text.Blue> Pala<Text.Blue>{'</p>'} </Text.Blue><br></br>
            <Text.Blue nr_idents={1}>{'<p>'} </Text.Blue> é <Text.Blue>{'</p>'} </Text.Blue><br></br>
            <Text.Blue nr_idents={1}>{'<p>'} </Text.Blue> uma<Text.Blue>{'</p>'} </Text.Blue><br></br>
            <Text.Blue nr_idents={1}>{'<p>'} </Text.Blue> tara<Text.Blue>{'</p>'} </Text.Blue><br></br>
            <Text.Blue nr_idents={1}>{'<p>'} </Text.Blue> de<Text.Blue>{'</p>'} </Text.Blue><br></br>
            <Text.Blue nr_idents={1}>{'<p>'} </Text.Blue> sabor<Text.Blue>{'</p>'} </Text.Blue><br></br>
            <Text.Blue>{'<div>'}</Text.Blue> <br></br>
        ...
        <table >
            ...
            <tr>
                ...
                <td>0,0,1,3</td>
                <td>One class is worth one point in the second box. 3 more elements, 3 more points in the first square.</td>
            </tr>
            <tr>
                <td>a:hover</td>
                <td>0,0,1,1</td>
                <td>An element, a point in the first square. One pseudo-class, which is equivalent to a class (a point in the second square).</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="hidden">Two elements, two points in the first square. An ID, a point in the third box.</td>
            </tr>
        </table>

        <h3>The Fourth Square</h3> 
        <div>
            In the examples above we saw up to the third house. The fourth box is used on two occasions: <br>
            </br>
            <ol>
                <li> When we put CSS inline, that is, directly in the HTML element. </li>
                <li> When we have the! Important value declared in the CSS code value</li>
                </ol>
